Ext.namespace("SampleApp.Actions");

/**
 * Attach the Actions panel to the West Panel
 */
Ext.onReady(function(){
    var actionsPanel = new SampleApp.Actions.Panel();
    SampleApp.Main.WestPanelInstance.add(actionsPanel);
    SampleApp.Main.WestPanelInstance.doLayout();
    
    SampleApp.Main.EventRelay.fireEvent("log",{
        severity: "info",
        from: "action.js",
        message: "Actions panel loaded",
    });
});
 ...
 */
SampleApp.Actions.Panel = function() {
 ...
 */
Ext.extend(SampleApp.Actions.Panel, Ext.Panel, {
