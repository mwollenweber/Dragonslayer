...
$query = "SELECT id, discovered, reporter, event, INET_NTOA(victim), INET_NTOA(attacker), netid, dns_name, network, dhcp_info, verification, notes, report_category FROM gwcases ORDER BY tdstamp DESC LIMIT 50";
