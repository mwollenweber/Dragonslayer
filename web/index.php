...
<html>
	<head>
		...
		<script src="script/portlets/health_status_portlet.js" type="text/javascript"></script>
		<script src="script/portlets/needs_research_portlet.js" type="text/javascript"></script>
